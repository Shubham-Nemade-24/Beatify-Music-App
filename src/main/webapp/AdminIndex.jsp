...
<header>
    <div class="menu_side">
        ...
        <!--<h4 class="active"><span></span><i class="bi bi-music-note-beamed"></i> Playlist</h4> 
          ...
          <h4 class="active" ><span></span><i class="bi bi-music-note-beamed"></i> Upload</h4>
          <h4 class="active" ><span></span><i class="bi bi-music-note-beamed"></i>Popular songs</h4>
          <h4 class="active" ><span></span><i class="bi bi-music-note-beamed"></i><a href="Review.jsp">Review</a></h4>
           -->
        </div>
        <div class="menu_song">
           <li class="songItem">
    ...
    <div class="song_side">
        <nav>
            ...
            <div>
            <h2 class="active"><span></span><i class="bi bi-music-note-list"></i>&ensp;Life goes on, let the music play !</h2></a>
            </div>
            <!-- <div class="search">
        ...
        <div class="content">
            ...
            <span>&ensp;Why Beatify?</span><br>
            <span>&ensp;It's free.</span>
            <div class="buttons">
              <form action="fav.jsp"><button>FAVOURITES</button></form>
            </div>
        </div>
        ...
        <div class="popular_artists">
            ...
            <div class="item">
                ...
                <li>
                    <img src="img/neeraj.jpg" alt="Neeraj Shridhar" title="Neeraj Shridhar">
                </li>
                 <li>
                    <img src="img/sonu.jpg" alt="Sonu Nigam" title="Sonu Nigam">
                </li>
                <li>
                    <img src="img/shaan.jpeg" alt="Shaan" title="Shaan">
                </li>
                <li>
                    <img src="img/rahman.jpg" alt="A R Rahman" title="A R Rahman">
                </li>
